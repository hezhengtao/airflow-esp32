...
#define CONFIG_EXAMPLE_LCD_TOUCH_ENABLED    1       //Touch
...
static esp_err_t lcd_init(void)
{
    ...
    ESP_ERROR_CHECK(esp_lcd_new_panel_TK050F9039(lcd_io, &panel_config, &lcd_panel));
...
static esp_err_t lvgl_init(void)
{
    ...
    const lvgl_port_display_cfg_t disp_cfg = {
        ...
        .buffer_size = EXAMPLE_LCD_H_RES * EXAMPLE_LCD_V_RES * sizeof(uint16_t),
        .double_buffer = true,
        .trans_size = false,
