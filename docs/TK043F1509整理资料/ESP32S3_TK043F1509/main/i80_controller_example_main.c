...
#define EXAMPLE_PIN_NUM_DATA8          9
#define EXAMPLE_PIN_NUM_DATA9          10
#define EXAMPLE_PIN_NUM_DATA10         11
#define EXAMPLE_PIN_NUM_DATA11         0
#define EXAMPLE_PIN_NUM_DATA12         45
#define EXAMPLE_PIN_NUM_DATA13         48
#define EXAMPLE_PIN_NUM_DATA14         47
#define EXAMPLE_PIN_NUM_DATA15         21
#endif
#define EXAMPLE_PIN_NUM_PCLK           2
#define EXAMPLE_PIN_NUM_CS             1
#define EXAMPLE_PIN_NUM_DC             42
#define EXAMPLE_PIN_NUM_RD             41//不使用的时候，可以直接接3.3V
#define EXAMPLE_PIN_NUM_RST            46
...
#if CONFIG_EXAMPLE_LCD_I80_CONTROLLER_TK020RB424
#define EXAMPLE_LCD_CMD_BITS           16
#define EXAMPLE_LCD_PARAM_BITS         16
#elif CONFIG_EXAMPLE_LCD_I80_CONTROLLER_ST7789
#define EXAMPLE_LCD_CMD_BITS           16
#define EXAMPLE_LCD_PARAM_BITS         16
...
void example_init_lcd_panel(esp_lcd_panel_io_handle_t io_handle, esp_lcd_panel_handle_t *panel)
{
    ...
    gpio_config_t io_conf = {
        .pin_bit_mask = (1ULL << EXAMPLE_PIN_NUM_RD),  // 选择要配置的引脚
    ...
    gpio_set_direction(EXAMPLE_PIN_NUM_RD, GPIO_MODE_OUTPUT);//RD不使用时可以接到3.3V上
    gpio_set_level(EXAMPLE_PIN_NUM_RD, 1);
    
#if CONFIG_EXAMPLE_LCD_I80_CONTROLLER_TK020RB424
    ESP_LOGI(TAG, "Install LCD driver of TK020RB424");
    ...
    ESP_ERROR_CHECK(esp_lcd_new_panel_TK020RB424(io_handle, &panel_config, &panel_handle));
